...
export const config = {
  ...
  ENDPOINTS: {
    ...
    ADMIN: {
      ...
      NOTIFICATIONS_UNREAD: "/api/admin/notifications/unread",
      NOTIFICATIONS_UNREAD_COUNT: "/api/admin/notifications/unread/count",
      NOTIFICATION_MARK_READ: "/api/admin/notifications/:id/read",
      NOTIFICATIONS_MARK_ALL_READ: "/api/admin/notifications/read-all",
      ...
      LEGAL_DOCUMENT_BY_ID: "/api/admin/legal-documents/:id",
      LEGAL_DOCUMENT_ACTIVE: "/api/admin/legal-documents/active",
      LEGAL_DOCUMENT_ACTIVATE: "/api/admin/legal-documents/:id/activate",
      LEGAL_DOCUMENT_DEACTIVATE: "/api/admin/legal-documents/:id/deactivate",
      ...
      GOOGLE_DRIVE: "/api/admin/google-drive",
      GOOGLE_DRIVE_BY_ID: "/api/admin/google-drive/:id",
      GOOGLE_DRIVE_ACTIVE: "/api/admin/google-drive/active",
      GOOGLE_DRIVE_TEST: "/api/admin/google-drive/:id/test",
      INVOICES: "/api/admin/invoices",
      INVOICES_BY_ID: "/api/admin/invoices/:id",
      ...
      CREATE_DRIVER_SUBSCRIPTION: "/api/admin/subscription-plans/create-subscription",
